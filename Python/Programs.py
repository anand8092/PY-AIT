...
# 12.Write a Python program to remove the characters which
...
# def validateURL(url):
#     regex = "^((http|https)://)[-a-zA-Z0-9@:%.\\+~#?&//=]{2,256}\\.[a-z]{2,6}$"
#     r = re.compile(regex)
...
# t1 = Thread(target=wish, args=("Varad", 23))
# t2 = Thread(target=wish, args=("Yogesh", 30))
# t1.start()
# t2.start()
...
# if a > b and a > c:
#     print(a, "is greater among 3 numbers")
# elif b > a and b > c:
#     print(b, "is greater among 3 numbers")
# else:
#     print(c, "is greater among 3 numbers")
...
#         return 1
#     elif n < 0:
#         print("Number caan't ne negative")
#     else:
#         return n*fact(n-1)
...
#     f2.close()
#     f3.close()
#     print("Data written to Merge.txt successfully")
...
# t1 = Thread(target=wish, args=("Varad", 23))
# t2 = Thread(target=wish, args=("Yogesh", 25))
# t1.start()
# t2.start()
